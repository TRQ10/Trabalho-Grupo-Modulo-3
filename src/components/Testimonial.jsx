...
const Testimonial = () => {
  ...
  return (
    ...
    >
      <h2 class="text-4xl font-bold tracking-tight sm:text-5xl  text-center">
        Nossos Artistas
      </h2>
    <section class="bg-white">
    <div class="mx-auto max-w-screen-xl px-2 py-6 sm:px-6 sm:py-24 lg:px-8">
    <div
    ...
    >
      <div>
        ...
        >
          <p class="text-lg font-bold text-gray-700">{funcionarios.nome}</p>
      ...
      <div>
        ...
        <blockquote
          class="-mt-6 flex flex-col justify-between rounded-lg p-12 text-center shadow-xl"
        >
          <p class="text-lg font-bold text-gray-700">{funcionarios1.nome}</p>
          <p class="mt-1 text-xs font-medium text-gray-500">
            {funcionarios1.cargo}
          </p>
          <p class="mt-4 text-sm text-gray-500">
      ...
      <div>
        ...
        <blockquote
          class="-mt-6 flex flex-col justify-between rounded-lg p-12 text-center shadow-xl"
        >
          <p class="text-lg font-bold text-gray-700">{funcionarios2.nome}</p>
          <p class="mt-1 text-xs font-medium text-gray-500">
            {funcionarios2.cargo}
          </p>
          <p class="mt-4 text-sm text-gray-500">
